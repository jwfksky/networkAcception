/**
 * DigestUtils.java [V 1.0.0]
 * classes : com.harbour.testData.sha.util.DigestUtils
 * zhangyx Create at 2014-6-19.上午10:46:48
 */
 ...
 * 
 * 
 * com.harbour.testData.sha.util.DigestUtils
 * 
 * @author zhangyx <br/>
 *         create at 2014-6-19 上午10:46:48
 * 
 */
...
public class DigestUtils {
	...
	public static String encodeMD5Hex(byte[] data) {
        ...
        return org.apache.commons.codec.binary.Hex.encodeHexString(encodeMD5(data));
	}
	...
	public static String encodeSHAHex(byte[] data) {
		...
		return org.apache.commons.codec.binary.Hex.encodeHexString(getShaDigest().digest(data));
	}
	...
	public static String encodeSHA256Hex(byte[] data) {
		return org.apache.commons.codec.binary.Hex.encodeHexString(encodeSHA256(data));
	}
	...
	public static String encodeSHA384Hex(byte[] data) {
		return org.apache.commons.codec.binary.Hex.encodeHexString(encodeSHA384(data));
	}
	...
	public static String encodeSHA512Hex(byte[] data) {
		return org.apache.commons.codec.binary.Hex.encodeHexString(encodeSHA512(data));
	}
